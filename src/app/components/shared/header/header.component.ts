...
export class HeaderComponent implements OnInit {
  ...
  constructor(private cartService: CartService, public appSettings:AppSettings,private router: Router){
  ...
  public searchItem(event){
    if(event.target.value === ''){
      ...
      console.log('ELSE');
      this.router.navigate(['/home/products/'],{queryParams: {searchedItem: event.target.value},})
